...
const EX = {
  ...
  seatedLegCurl:{name:'כפיפות רגליים — ישיבה',en:'Seated Leg Curl',e:'',cat:'ירך אחורי',sets:'3×10–15',rest:'75 שנ׳',lvl:'בידוד',
    desc:'ישיבה עם הירך כפופה, כרית מעל הקרסוליים, כיפוף הברכיים לאחור. ההבדל מהגרסה בשכיבה: הירך הכפופה מאריכה את הירך האחורי לאורך כל התרגיל.',
    muscles:'Hamstrings (Biceps Femoris, Semitendinosus, Semimembranosus).',
    tips:['הישבן צמוד למושב — לא מתרומם','כרית האגן הדוקה כדי שלא תעוף מהכיסא','ירידה איטית — שם רוב הגירוי','אל תנעל ברכיים בפתיחה','טווח מלא עדיף על משקל כבד']},
...
const EX_YT={
  ...
  // Written per exercise rather than left to the generic fallback: the
  // fallback builds its query from the English name, and a name carrying a
  // slash or too little detail sends the lifter to the wrong movement.
  abWheel:'ab wheel rollout proper form beginner tutorial',
  abductorMachine:'hip abduction machine glute medius proper form',
  adductorMachine:'hip adduction machine inner thigh proper form',
  bandChestPress:'resistance band chest press proper form tutorial',
  bandCurl:'resistance band bicep curl proper form tutorial',
  bandFacePull:'resistance band face pull proper form tutorial',
  bandGoodMorning:'resistance band good morning hamstring proper form',
  bandLateral:'resistance band lateral raise proper form tutorial',
  bandPulldown:'resistance band lat pulldown kneeling proper form',
  bandRow:'resistance band seated row proper form tutorial',
  bandTricep:'resistance band triceps extension proper form tutorial',
  bulgSplitHome:'bulgarian split squat using a chair at home proper form',
  bulgarianSplit:'bulgarian split squat dumbbell proper form tutorial',
  bwSquat:'bodyweight air squat proper form tutorial',
  cableChestFly:'cable chest fly crossover proper form tutorial',
  cableCrunch:'kneeling cable crunch abs proper form tutorial',
  cableLateral:'cable lateral raise side delt proper form tutorial',
  cableTricepOverhead:'cable overhead triceps extension rope proper form',
  calfRaiseHome:'single leg calf raise on a step proper form tutorial',
  chestSupportedRow:'chest supported dumbbell row incline bench proper form',
  chinUp:'chin up underhand grip proper form tutorial',
  chinupHome:'doorway pull up bar chin up at home proper form',
  closeGripBenchDB:'close grip barbell bench press triceps proper form',
  dbFloorPress:'dumbbell floor press proper form tutorial',
  dbGobletSquat:'dumbbell goblet squat proper form tutorial',
  dbRdl:'dumbbell romanian deadlift proper form tutorial',
  dbReverseFly:'bent over dumbbell reverse fly rear delt proper form',
  dbRow:'one arm dumbbell row bench supported proper form',
  dbShoulderPress:'seated dumbbell shoulder press proper form tutorial',
  declinePushup:'decline push up feet elevated upper chest proper form',
  doorRow:'inverted row under a table at home proper form',
  gluteBridgeSL:'single leg glute bridge proper form tutorial',
  hangingLegRaise:'hanging leg raise abs proper form tutorial',
  hollowHold:'hollow body hold proper form tutorial',
  inclineChestPress:'incline chest press machine proper form tutorial',
  inclineDB:'incline dumbbell bench press proper form tutorial',
  legPressNarrow:'narrow stance leg press quad emphasis proper form',
  machineShoulderPress:'machine shoulder press proper form tutorial',
  nordicHome:'nordic hamstring curl at home beginner progression',
  pecDeck:'pec deck machine chest fly proper form tutorial',
  pikePushup:'pike push up shoulder press progression proper form',
  pistolBox:'box pistol squat progression proper form tutorial',
  plank:'front plank hold proper form tutorial abs',
  plankReach:'plank shoulder tap proper form tutorial',
  proneReverseFly:'prone y raise t raise rear delt on floor proper form',
  pushup:'push up proper form tutorial chest',
  reverseCurl:'reverse grip barbell curl brachialis proper form',
  reverseFly:'reverse pec deck machine rear delt fly proper form',
  seatedDBPress:'seated dumbbell overhead press proper form tutorial',
  seatedLegCurl:'seated leg curl machine hamstring proper form tutorial',
  sidePlank:'side plank hold proper form tutorial obliques',
  singleArmRow:'one arm dumbbell row proper form tutorial',
  singleLegRDL:'single leg romanian deadlift dumbbell proper form',
  underhandPulldown:'underhand close grip lat pulldown proper form tutorial',
  arnoldPressDB:'arnold press dumbbell shoulder proper form tutorial',
  benchDipsArms:'bench dips triceps proper form tutorial',
  boxJump:'box jump proper form landing technique tutorial',
  cableRowSeat:'seated cable row proper form tutorial back',
  concentrationCurl:'concentration curl dumbbell biceps proper form',
  crunchMachine:'ab crunch machine proper form tutorial',
  dbSkullCrusher:'dumbbell skull crusher lying triceps extension proper form',
  declineBench:'decline barbell bench press lower chest proper form',
  dragonFlag:'dragon flag progression proper form tutorial',
  gluteBridge:'barbell glute bridge proper form tutorial',
  gobletSquat:'goblet squat kettlebell dumbbell proper form tutorial',
  inclineCurlDB:'incline dumbbell curl long head biceps proper form',
  machineRow:'seated machine row chest supported proper form',
  reverseGripCurl:'reverse grip barbell curl forearm brachialis proper form',
  ropePushdown:'rope triceps pushdown cable proper form tutorial',
  russianTwist:'russian twist obliques proper form tutorial',
  spiderCurl:'spider curl incline bench biceps proper form',
  sumoSquat:'sumo squat wide stance proper form tutorial',
  tBarRowV2:'t bar row landmine back proper form tutorial',
  toeTouch:'toe touch crunch abs proper form tutorial',
  vUp:'v up abs proper form tutorial',
  walkingLunge:'walking lunges dumbbell proper form tutorial',
  wristCurlDB:'dumbbell wrist curl forearm proper form tutorial',
  zottmanCurl:'zottman curl dumbbell biceps forearm proper form',
};
...
const WORKOUT_PLANS={
  ...
  4:{
    days:[
      {id:'push',label:'דחיפה — חזה + כתפיים',shortLabel:'דחיפה',color:'#CCFF00',
       exercises:['benchPress','ohp','inclineBench','cableFlye','lateralRaise','reverseFly','triPushdown']},
      {id:'pull',label:'משיכה — גב + בייסס',shortLabel:'משיכה',color:'#00D9FF',
       exercises:['pullup','underhandPulldown','bentRow','cableRow','rdl','facePull','cableLateral','bbCurl','hangingLegRaise']},
  ...
  '4ant':{
    days:[
      ...
      {id:'arms',label:'B׳׳ — גב, יד אחורית ורגליים (ציר)',shortLabel:'B ציר',color:'#FF7A45',
       exercises:['deadlift','underhandPulldown','singleArmRow','bulgarianSplit','seatedLegCurl','hipThrust','seatedCalfRaise','cableTricepOverhead']},
    ],
    dows:[0,1,3,4],
  ...
  '4ab':{
    days:[
      ...
      {id:'arms',label:'תחתון ב׳ — ציר וחד-צדדי',shortLabel:'תחתון ב׳',color:'#FF7A45',
       exercises:['deadlift','bulgarianSplit','legPressNarrow','singleLegRDL','abductorMachine','adductorMachine','seatedCalfRaise']},
    ],
    dows:[0,1,3,4],
    schedule:'א׳ עליון א׳ · ב׳ תחתון א׳ · ד׳ עליון ב׳ · ה׳ תחתון ב׳'
  },
...
function getWorkoutFreqLabel(freq,split){
  ...
  if(freq===3) return split==='3ab'?'3×/שבוע — AB (עליון/תחתון)':split==='3ss'?'3×/שבוע — סופרסטים פול-בודי':'3×/שבוע — PPL (דחיפה/משיכה/רגליים)';
  if(freq===4) return split==='4ab'?'4×/שבוע — AB (עליון/תחתון)':split==='4ant'?'4×/שבוע — ANT (שרירים נגדיים)':'4×/שבוע — PPL (דחיפה/משיכה/רגליים + ידיים)';
